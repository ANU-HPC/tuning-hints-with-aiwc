...
%	With $E_{n,t}$ the n-bits-dropped entropy at timestamp $t$.
	...
	This dependency enforces a wave-front computation pattern, travelling along the main diagonal of the matrix. Each iteration of the kernels computes over an antidiagonal of the matrix, starting at its top left corner, and finishing at its bottom right corner.
