...
\begin{document}
	...
	We see an improvement to 600 GFLOP/s in effective performance for order 2048 matrix multiplication.
...
%	With $E_{n,t}$ the n-bits-dropped entropy at timestamp $t$.
	...
	\section{Guidelines: Using the Parallel Spatial Locality Metric} \label{guidelines}
	 ...
	 Codes with a mix of favourable and unfavourable access patterns (typically involving two-dimensional matrices such as in LUD and SRAD) will have a steep dropoff in PSL to about half of the starting PSL metric as $n$ increases, and the curve flattens out at that point.
	 ...
	 The worst possible memory access pattern occurs when all threads in a workgroup access disparate memory locations. This results in a flat PSL metric of 1. 
