...
\begin{document}
	...
	The Architecture Independent Workload Characterisation (AIWC) tool is a plugin for the Oclgrind OpenCL simulator that gathers metrics of OpenCL programs used to understand and predict program performance on an arbitrary given hardware architecture.
