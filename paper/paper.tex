...
\begin{document}
	...
	In section \ref{method} we consider non-parallel memory metrics collected by the architecture-independent workload characterization tool and evaluate the suitability of these metrics for capturing the impact of performance optimizations to various OpenCL codes.
